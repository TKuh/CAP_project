...
modeling := ModelingCategory( product_insmat );;
...
F_product_perms := IsomorphismFromCoreToProductCategoryOfPermutationCategory( product_insmat );;

F_rows := FunctorInsertionMatricesToCategoryOfRows( ins_mat, rows );;

Display( product_insmat );
...
terminal := ObjectConstructor( product_insmat, [ 0, [ ], [ ] ] );;
Display( terminal );
#! [ 0, [  ], [  ] ]

one := ObjectConstructor( product_insmat, [ 1, [ 1 ], [ 1 ] ] );;
Display( one );
#! [ 1, [ 1 ], [ 1 ] ]
...
source := ObjectConstructor( product_insmat, [ 2, [ 1, 3 ], [ 1, 5 ] ] );;
IsWellDefinedForObjects( source );
#! true
Display( source );
#! [ 2, [ 1, 3 ], [ 1, 5 ] ]

source_model := ModelingObject( product_insmat, source );;
IsWellDefinedForObjects( source_model );
#! true

source = ReinterpretationOfObject( product_insmat, source_model );
#! true

source_model := ModelingTowerObjectConstructor( product_insmat, [ 2, [ 1, 3 ], [ 1, 5 ] ] );;
IsWellDefinedForObjects( source_model );
#! true
...
source := ObjectConstructor( product_insmat, [ 4, [ 1, 2, 3, 5 ], [ 1, 4, 1, 1 ] ] );;
target := ObjectConstructor( product_insmat, [ 2, [    2, 3    ], [    5, 2     ] ] );;
...
mor := MorphismConstructor( product_insmat, source, triple, target );;
IsWellDefinedForMorphisms( mor );
#! true

mor_model := ModelingMorphism( product_insmat, mor );;
mor_reiterp := ReinterpretationOfMorphism( product_insmat, source, mor_model, target );;
...
source_model := ModelingTowerObjectConstructor( product_insmat, [ 4, [ 1, 2, 3, 5 ], [ 1, 4, 1, 1 ] ] );;
target_model := ModelingTowerObjectConstructor( product_insmat, [ 2, [    2, 3    ], [    5, 2     ] ] );;

IsWellDefinedForObjects( ModelingCategory( product_insmat ), source_model );
#! true
IsWellDefinedForObjects( ModelingCategory( product_insmat ), target_model );
#! true

mor_model := ModelingTowerMorphismConstructor( product_insmat, source_model, triple, target_model );;
mor_product_insmat := ReinterpretationOfMorphism( product_insmat, source, mor_model, target );;
IsWellDefinedForMorphisms( mor_product_insmat );
#! true
IsWellDefinedForMorphisms( mor_model );
#! true
mor_model = ModelingMorphism( product_insmat, mor_product_insmat );
#! true
...
object := ObjectConstructor( product_insmat, [ 2, [ 1, 3 ], [ 1, 5 ] ] );;
...
source := ObjectConstructor( product_insmat, [ 4, [ 1, 2, 3, 5 ], [ 1, 2, 1, 1 ] ] );;
target := ObjectConstructor( product_insmat, [ 2, [    2, 3    ], [    1, 2    ] ] );;
...
mor := MorphismConstructor( product_insmat, source, matrices_triple, target );;
IsWellDefinedForMorphisms( mor );
#! true

# Display( ApplyFunctor( F_rows, ModelingMorphism( product_insmat, mor )[2] ) );
# Display( ApplyFunctor( F_rows, ModelingMorphism( product_insmat, mor )[3] ) );
...
mor_id_object := PRODUCT_OF_CATEGORY_OF_INSERTION_MATRICES_AS_SUBCAT_TensorProductOfMorphismWithIdentityWithGivenTensorProducts(
    product_insmat, source_tp, mor, id_object, target_tp );;

IsEqualForMorphisms( mor_id_object, TensorProductOnMorphisms( mor, id_object ) );
#! true

test_source := ObjectConstructor( product_insmat, [ 2, [ 3, 4 ], [ 3, 1 ] ] );
test_target := ObjectConstructor( product_insmat, [ 2, [ 3, 4 ], [ 3, 1 ] ] );
c := ObjectConstructor( product_insmat, [ 2, [ 1, 4 ], [ 1, 2 ] ] );;
...
test_morphism := MorphismConstructor( product_insmat, test_source, triple, test_target );;
...
source_tp := ObjectConstructor( product_insmat, [ 4, [ 2, 3, 4, 5 ], [ 9, 5, 8, 2 ] ] );;
target_tp := ObjectConstructor( product_insmat, [ 4, [ 2, 3, 4, 5 ], [ 9, 5, 8, 2 ] ] );;
...
test_morphism_id_c := PRODUCT_OF_CATEGORY_OF_INSERTION_MATRICES_AS_SUBCAT_TensorProductOfMorphismWithIdentityWithGivenTensorProducts(
    product_insmat, source_tp, test_morphism, id_c, target_tp );;
...
id_object_mor := PRODUCT_OF_CATEGORY_OF_INSERTION_MATRICES_AS_SUBCAT_TensorProductOfIdentityWithMorphismWithGivenTensorProducts(
    product_insmat, source_tp, id_object, mor, target_tp );;
...
id_c_test_morphism := PRODUCT_OF_CATEGORY_OF_INSERTION_MATRICES_AS_SUBCAT_TensorProductOfIdentityWithMorphismWithGivenTensorProducts(
    product_insmat, source_tp, id_c, test_morphism, target_tp );;
...
a := ObjectConstructor( product_insmat, [ 2, [1,4], [4,2] ] );;
b := ObjectConstructor( product_insmat, [ 3, [2,3,5], [6,2,10] ] );;
...
b1 := ObjectConstructor( product_insmat, [ 1, [2], [1] ] );;
b2 := ObjectConstructor( product_insmat, [ 1, [3], [1] ] );;
b3 := ObjectConstructor( product_insmat, [ 1, [5], [1] ] );;
left_expanding_with_mults := LeftDistributivityExpandingWithGivenMultiplicitiesAndObjects( product_insmat, ab, a, [ b1, b2, b3 ], [ 6, 2, 10 ], ab );;
# time;
# 58
...
# e := ObjectConstructor( product_insmat, [ 4, [1,2,3,4], [20,76,25,13] ] );;
...
# left_expanding_with_mults := LeftDistributivityExpandingWithGivenMultiplicitiesAndObjects( product_insmat,
#                                     a_product_L,
#                                     a,
#                                     [ b, c, d, e, f ],
#                                     [ 64, 24, 80, 20, 40 ],
...
b2 := ObjectConstructor( product_insmat, [ 1, [3], [1] ] );;
b3 := ObjectConstructor( product_insmat, [ 1, [5], [1] ] );;
right_expanding_with_mults := RightDistributivityExpandingWithGivenMultiplicitiesAndObjects( product_insmat, ba, [ b1, b2, b3 ], a, [ 6, 2, 10 ], ba );;
# time;
# 66
...
a := ObjectConstructor( product_insmat, [ 3, [1,2,4], [40,25,30] ] );;
b := ObjectConstructor( product_insmat, [ 3, [2,3,5], [60,29,105] ] );;
ba := TensorProductOnObjects( b, a );;
L := DecompositionIntoSimpleObjects( b );;
...
b2 := ObjectConstructor( product_insmat, [ 1, [3], [1] ] );;
b3 := ObjectConstructor( product_insmat, [ 1, [5], [1] ] );;
right_expanding_with_mults := RightDistributivityExpandingWithGivenMultiplicitiesAndObjects( product_insmat, ba, [ b1, b2, b3 ], a, [ 60, 29, 105 ], ba );;
# time;
# 976
...
# right_expanding_with_mults := RightDistributivityExpandingWithGivenMultiplicitiesAndObjects( product_insmat,
#                                     L_product_a,
#                                     [ b, c, d, e, f ],
#                                     a,
#                                     [ 64, 24, 80, 20, 40 ],
...
object := ObjectConstructor( product_insmat, [ 4, [ 1, 2, 3, 5 ], [ 1, 2, 4, 3 ] ] );;
...
mor := MorphismConstructor( product_insmat, object, matrices_triple, object );;
IsWellDefinedForMorphisms( mor );
#! true
