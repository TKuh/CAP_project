...
CompareEvaluationMorphisms( A : timing_statistics := true, check_equality := true );

CompareEvaluationMorphisms( B : timing_statistics := true, check_equality := true );

CompareEvaluationMorphisms( BC : timing_statistics := true, check_equality := true );

CompareEvaluationMorphisms( BC : timing_statistics := true, check_equality := false );

CompareEvaluationMorphisms( AC : timing_statistics := true, check_equality := false );
