...
CompareBraidingMorphisms :=
  function( A, B )
    ...
    morphism_multiplicity := SGREPS_Braiding_2_Morphism_multiplicity( product_insmat, A, B, AB );
    ...
    if check_equality then
        ...
        F := IsomorphismFromCoreToProductCategoryOfPermutationCategory( product_insmat );
