...
L := DecompositionIntoListOfSupportingObjects( z );
#! [  ]
Length( L ) = NrSupport( z );
#! true

L := DecompositionIntoListOfSupportingObjects( source );;
Display( L[1] );
#! 2χ₂
Display( L[2] );
#! χ₃
Display( L[3] );
#! χ₅
Length( L ) = NrSupport( source );
#! true

L := DecompositionIntoListOfSupportingObjects( target );;
Display( L[1] );
#! 3χ₁
Display( L[2] );
#! χ₂
