...
ReadPackage( "GroupRepresentationsForCAP", "gap/SemisimpleCategory.gd" );

ReadPackage( "GroupRepresentationsForCAP", "gap/GIrreducibleObjects.gd" );

ReadPackage( "GroupRepresentationsForCAP", "gap/GZGradedIrreducibleObjects.gd" );
