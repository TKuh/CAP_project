...
#! @Arguments object
#! @Returns a list
DeclareAttribute( "ListOfPairsOfMatrixAndIndex", IsObjectInSkeletalCategoryOfGroupRepresentations );

CapJitAddTypeSignature( "ListOfPairsOfMatrixAndIndex", [ IsObjectInSkeletalCategoryOfGroupRepresentations ],
  function ( input_types )
...
#! @Description
DeclareGlobalFunction( "CAP_INTERNAL_skeletal_group_reps_decompose_character" );
