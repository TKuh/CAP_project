...
# Implementations
#
BindGlobal( "ADD_FUNCTIONS_FOR_SparseProduct_CategoryOfPermutations_AsSubcategoryOfSkeletalGroupRepresentations_S4_precompiled", function ( cat )
...
function ( cat_1, P_1, objects_1, L_1, objectsp_1, Pp_1 )
    ...
    deduped_5_1 := Length( deduped_6_1 );
    deduped_4_1 := [ 1 .. Length( L_1 ) ];
    hoisted_3_1 := [ 0 ];
    hoisted_2_1 := [ PermList( CapJitTypedExpression( [  ], function (  )
                  return rec(
                      filter := IsList,
                      element_type := rec(
                          filter := IsInt ) );
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, P_1, Pp_1, TripleOfNrSupportListOfSupportListOfPermutations, NTuple( 3, deduped_5_1, deduped_6_1, List( [ 1 .. deduped_5_1 ], function ( n_2 )
                local deduped_1_2, deduped_2_2, hoisted_3_2;
                deduped_1_2 := deduped_6_1[CAP_JIT_INCOMPLETE_LOGIC( n_2 )];
                deduped_2_2 := List( objects_1, function ( x_3 )
                        local hoisted_1_3, deduped_2_3, deduped_3_3;
                        deduped_3_3 := TripleOfNrSupportListOfSupportListOfCardinalitites( x_3 );
                        deduped_2_3 := deduped_3_3[2];
                        hoisted_1_3 := deduped_3_3[3];
                        return [ hoisted_3_1, List( [ 1 .. deduped_3_3[1] ], function ( n_4 )
                                          return hoisted_1_3[n_4];
                                      end ){Positions( deduped_2_3, deduped_1_2 )} ][1 + BooleanToInteger( deduped_1_2 in deduped_2_3 )][1];
                    end );
                hoisted_3_2 := List( deduped_4_1, function ( i_3 )
                        return deduped_2_2[i_3];
                    end );
                return CAP_JIT_INCOMPLETE_LOGIC( PermList( Concatenation( List( deduped_4_1, function ( i_3 )
                              local hoisted_1_3, hoisted_2_3, deduped_3_3, deduped_4_3, deduped_5_3;
                              deduped_5_3 := CAP_JIT_INCOMPLETE_LOGIC( i_3 );
                              deduped_4_3 := TripleOfNrSupportListOfSupportListOfPermutations( CAP_JIT_INCOMPLETE_LOGIC( L_1[deduped_5_3] ) );
                              deduped_3_3 := deduped_4_3[2];
                              hoisted_2_3 := CAP_JIT_INCOMPLETE_LOGIC( Sum( hoisted_3_2{[ 1 .. deduped_5_3 - 1 ]} ) );
                              hoisted_1_3 := deduped_4_3[3];
                              return CAP_JIT_INCOMPLETE_LOGIC( List( ListPerm( CAP_JIT_INCOMPLETE_LOGIC( [ hoisted_2_1, List( [ 1 .. deduped_4_3[1] ], function ( n_4 )
                                                        return hoisted_1_3[n_4];
                                                    end ){Positions( deduped_3_3, deduped_1_2 )} ][1 + BooleanToInteger( deduped_1_2 in deduped_3_3 )][1] ), deduped_2_2[deduped_5_3] ), function ( j_4 )
                                        return j_4 + hoisted_2_3;
                                    end ) );
                          end ) ) ) );
            end ) ) );
end
...
function ( cat_1, P_1, objects_1, L_1, objectsp_1, Pp_1 )
    ...
    hoisted_5_1 := List( deduped_6_1, function ( n_2 )
            local deduped_1_2, hoisted_2_2, deduped_3_2, hoisted_4_2, hoisted_5_2;
            deduped_1_2 := deduped_8_1[n_2];
            deduped_3_2 := List( objects_1, function ( x_3 )
                    local hoisted_1_3, deduped_2_3, deduped_3_3;
                    deduped_3_3 := TripleOfNrSupportListOfSupportListOfCardinalitites( x_3 );
                    deduped_2_3 := deduped_3_3[2];
                    hoisted_1_3 := deduped_3_3[3];
            ...
            hoisted_4_2 := List( deduped_4_1, function ( i_3 )
                    return deduped_3_2[i_3];
                end );
            hoisted_5_2 := List( deduped_4_1, function ( i_3 )
                    return Sum( hoisted_4_2{[ 1 .. i_3 - 1 ]} );
                end );
            hoisted_2_2 := List( L_1, function ( x_3 )
                    local hoisted_1_3, deduped_2_3, deduped_3_3;
                    deduped_3_3 := TripleOfNrSupportListOfSupportListOfPermutations( x_3 );
                    deduped_2_3 := deduped_3_3[2];
                    hoisted_1_3 := deduped_3_3[3];
                    return [ hoisted_2_1, List( [ 1 .. deduped_3_3[1] ], function ( n_4 )
                                      return hoisted_1_3[n_4];
            ...
            return PermList( Concatenation( List( deduped_4_1, function ( i_3 )
                        local hoisted_1_3;
                        hoisted_1_3 := hoisted_5_2[i_3];
                        return List( deduped_4_1, function ( i_4 )
                                  return List( ListPerm( hoisted_2_2[i_4], deduped_3_2[i_4] ), function ( j_5 )
                                          return j_5 + hoisted_1_3;
                                      end );
                              end )[i_3];
                    end ) ) );
        end );
...
BindGlobal( "SparseProduct_CategoryOfPermutations_AsSubcategoryOfSkeletalGroupRepresentations_S4_precompiled", function ( irreducible_characters )
  local category_constructor, cat;
    ...
    return SparseProductOfCategoryOfPermutationsAsSubcategoryOfSkeletalGroupRepresentations( irreducible_characters : no_precompiled_code := true,
    ...
    ADD_FUNCTIONS_FOR_SparseProduct_CategoryOfPermutations_AsSubcategoryOfSkeletalGroupRepresentations_S4_precompiled( cat );
