...
InstallGlobalFunction( SGREPS_Braiding_1_Morphism_multiplicity,
  function( product_kron_comon, a, b, ab )
    ...
    return RightDistributivityExpandingWithGivenMultiplicitiesAndObjects( product_kron_comon, ab, a_xi, b, Components( a ), ab );
...
InstallGlobalFunction( SGREPS_Braiding_2_Morphism_multiplicity,
  function( product_kron_comon, a, b, ab )
    ...
    sigmas := List( [ 1 .. a_nr_support ], function( i )
        ...
        return LeftDistributivityExpandingWithGivenMultiplicitiesAndObjects( product_kron_comon, xib, xi, b_xj, b_components, xib );
    ...
    return DirectProductFunctorialWithGivenDirectProducts( product_kron_comon,
                ab,
...
InstallGlobalFunction( SGREPS_Braiding_4_Morphism_multiplicity,
  function( product_kron_comon, a, b, ab )
    ...
    sigmas := List( [ 1 .. a_nr_support ], function( i )
        ...
        xi := ObjectConstructor( product_kron_comon, NTuple( 3, 1, [ a_support[i] ], [ 1 ] ) );
        bxi := TensorProductOnObjects( product_kron_comon, b, xi );
...
InstallGlobalFunction( SGREPS_Braiding_12_Morphism_multiplicity,
  function( product_kron_comon, a, b, ab )
    ...
    morphism_1 := SGREPS_Braiding_1_Morphism_multiplicity( product_kron_comon, a, b, ab );
    
    morphism_2 := SGREPS_Braiding_2_Morphism_multiplicity( product_kron_comon, a, b, ab );
    ...
    # return SGREPS_FunctorFromMorphismPermutationsToMorphismMatrices( product_kron_comon, ab, morphism_12, ab );
    return morphism_12;
    
end );

InstallGlobalFunction( SGREPS_Braiding_45_Morphism_multiplicity,
  function( product_kron_comon, a, b, ba )
    ...
    morphism_4 := SGREPS_Braiding_4_Morphism_multiplicity( product_kron_comon, a, b, ba );
    
    morphism_5 := SGREPS_Braiding_5_Morphism_multiplicity( product_kron_comon, a, b, ba );
    
    # The composition of permutations π₂·π₁ corresponds to the permutation-matrix product P₁·P₂.
    morphism_45 := PreCompose( product_permcat, morphism_5, morphism_4 );
    
    # return SGREPS_FunctorFromMorphismPermutationsToMorphismMatrices( product_kron_comon, ba, morphism_45, ba );
    return morphism_45;
