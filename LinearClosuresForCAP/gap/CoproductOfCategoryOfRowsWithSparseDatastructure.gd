...
#!  datum $[ [ r_i, i ], \dots, [ r_j, j ] ]$,
#!  return the components $r_i, \dots, r_j$.
#! @Arguments object
#! @Returns a list of objects
DeclareAttribute( "Components", IsObjectInCoproductOfCategoryOfRowsWithSparseDatastructure );

#! @Description
#!  Given a morphism in <A>C</A> $\coloneqq \bigoplus_{i=1}^n \mathrm{Rows}_R$ with
#!  datum $[ [ m_i, i ], \dots, [ m_j, j ] ]$,
#!  return the components $m_i, \dots, m_j$.
#! @Arguments object
#! @Returns a list of morphisms
DeclareAttribute( "Components", IsMorphismInCoproductOfCategoryOfRowsWithSparseDatastructure );
...
#! @Description
# DeclareGlobalFunction( "COPRODUCT_OF_CATEGORY_OF_ROWS_MergePairsWithZero" );

#! @Description
DeclareGlobalFunction( "COPRODUCT_OF_CATEGORY_OF_ROWS_MergePairsWithZeroObject" );

CapJitAddTypeSignature( "COPRODUCT_OF_CATEGORY_OF_ROWS_MergePairsWithZeroObject",
                        [ IsCategoryOfRows, IsList, IsList, IsCategoryOfRowsObject ],
  function ( input_types )
...
#! @Description
DeclareGlobalFunction( "COPRODUCT_OF_CATEGORY_OF_ROWS_MergePairsWithZeroMorphism" );

CapJitAddTypeSignature( "COPRODUCT_OF_CATEGORY_OF_ROWS_MergePairsWithZeroMorphism",
                        [ IsCategoryOfRows, IsList, IsList, IsCategoryOfRowsMorphism ],
  function ( input_types )
...
#! @Description
DeclareGlobalFunction( "COPRODUCT_OF_CATEGORY_OF_ROWS_MergePairsWithZeroObjectInList" );

CapJitAddTypeSignature( "COPRODUCT_OF_CATEGORY_OF_ROWS_MergePairsWithZeroObjectInList",
                        [ IsCategoryOfRows, IsList, IsList, IsList ],
  function ( input_types )
...
#! @Description
# DeclareGlobalFunction( "COPRODUCT_OF_CATEGORY_OF_ROWS_MergeMatrixOfPairs" );

#! @Description
DeclareGlobalFunction( "COPRODUCT_OF_CATEGORY_OF_ROWS_MergeMatrixOfPairsOfObjectAndIndex" );

CapJitAddTypeSignature( "COPRODUCT_OF_CATEGORY_OF_ROWS_MergeMatrixOfPairsOfObjectAndIndex",
...
#! @Description
DeclareGlobalFunction( "COPRODUCT_OF_CATEGORY_OF_ROWS_MergeMatrixOfPairsOfMorphismAndIndex" );

CapJitAddTypeSignature( "COPRODUCT_OF_CATEGORY_OF_ROWS_MergeMatrixOfPairsOfMorphismAndIndex",
                        [ IsCategoryOfRows, IsList ],
  function ( input_types )
