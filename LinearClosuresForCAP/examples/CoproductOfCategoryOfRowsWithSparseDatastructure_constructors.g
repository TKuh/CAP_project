...
# Skip the zero morphisms 1,4,5 in the construction.
mor := MorphismConstructor( coproduct,
                            source,
                            [ morphism_pairs[2], morphism_pairs[3] ],
                            target );
...
# Explicitly including the zero morphisms 1,4,5 in the
# construction is also allowed, but not necessarry.
mor := MorphismConstructor( coproduct,
                            source,
                            [ morphism_pairs[1],
                              morphism_pairs[2],
