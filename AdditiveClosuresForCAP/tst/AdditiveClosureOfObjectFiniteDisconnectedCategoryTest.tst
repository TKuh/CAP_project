...
true
gap> D := FiniteSkeletalDiscreteCategory( [ 1 .. 3 ] );;
...
2 times: LinearClosureObject(<An object in FiniteSkeletalDiscreteCategory( [ 1 .. 3 ] )>)
2 times: LinearClosureObject(<An object in FiniteSkeletalDiscreteCategory( [ 1 .. 3 ] )>)
1 times: LinearClosureObject(<An object in FiniteSkeletalDiscreteCategory( [ 1 .. 3 ] )>)
...
1 times: LinearClosureObject(<An object in FiniteSkeletalDiscreteCategory( [ 1 .. 3 ] )>)
1 times: LinearClosureObject(<An object in FiniteSkeletalDiscreteCategory( [ 1 .. 3 ] )>)
0 times: LinearClosureObject(<An object in FiniteSkeletalDiscreteCategory( [ 1 .. 3 ] )>)
...
[ LinearClosureObject(<An object in FiniteSkeletalDiscreteCategory( [ 1 .. 3 ])>), 
  LinearClosureObject(<An object in FiniteSkeletalDiscreteCategory( [ 1 .. 3 ])>), 
  LinearClosureObject(<An object in FiniteSkeletalDiscreteCategory( [ 1 .. 3 ])>), 
  LinearClosureObject(<An object in FiniteSkeletalDiscreteCategory( [ 1 .. 3 ])>), 
  LinearClosureObject(<An object in FiniteSkeletalDiscreteCategory( [ 1 .. 3 ])>) ]
