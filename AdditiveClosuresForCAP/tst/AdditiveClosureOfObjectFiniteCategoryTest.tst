...
[1,1]: (1*<An identity morphism in FiniteSkeletalDiscreteCategory( [ 1 .. 2 ] )>) + (1*<An id\
entity morphism in FiniteSkeletalDiscreteCategory( [ 1 .. 2 ] )>)
[1,2]: 0
[1,3]: 0
[2,1]: 0
[2,2]: (1*<An identity morphism in FiniteSkeletalDiscreteCategory( [ 1 .. 2 ] )>) + (1*<An id\
entity morphism in FiniteSkeletalDiscreteCategory( [ 1 .. 2 ] )>)
[2,3]: 0
[3,1]: 0
[3,2]: 0
[3,3]: (1*<An identity morphism in FiniteSkeletalDiscreteCategory( [ 1 .. 2 ] )>) + (1*<An id\
entity morphism in FiniteSkeletalDiscreteCategory( [ 1 .. 2 ] )>)
