...
0 times: <An object in LinearClosure( FiniteSkeletalDiscreteCategory( [ 1 .. 2 ] ) )>
1 times: <An object in LinearClosure( FiniteSkeletalDiscreteCategory( [ 1 .. 2 ] ) )>
...
<A morphism in AdditiveClosureOfObjectFiniteCategory( LinearClosure( FiniteSkeletalDiscreteCa\
tegory( [ 1 .. 2 ] ) ) ) defined by a 3 x 3 matrix of underlying morphisms>
...
[1,1]: 2·<An identity morphism in FiniteSkeletalDiscreteCategory( [ 1 .. 2 ] )>
[1,2]: 0
[1,3]: 0
[2,1]: 0
[2,2]: 2·<An identity morphism in FiniteSkeletalDiscreteCategory( [ 1 .. 2 ] )>
[2,3]: 0
[3,1]: 0
[3,2]: 0
[3,3]: 2·<An identity morphism in FiniteSkeletalDiscreteCategory( [ 1 .. 2 ] )>
