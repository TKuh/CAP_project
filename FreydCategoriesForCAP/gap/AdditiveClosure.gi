  ...
  function( category )
    ...
    AddZeroObject( category,
      function( cat )
        ...
        return AdditiveClosureObject( cat, CapJitTypedExpression( [ ], { cat } -> rec( filter := IsList, element_type := CapJitDataTypeOfObjectOfCategory( UnderlyingCategory( cat ) ) ) ) );
    ...
    AddDirectSum( category,
      function( cat, list )
        ...
        return AdditiveClosureObject( cat, Concatenation( List( [ 1 .. Length( list ) ], i -> ObjectList( list[i] ) ) ) );
