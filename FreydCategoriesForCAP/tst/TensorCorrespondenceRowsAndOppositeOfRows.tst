...
gap> MonoidalCategoriesTensorProductAndUnitTest( rows, a, b : only_primitive_operations := true );;
...
gap> MonoidalCategoriesTest( rows, a, b, c, alpha, beta : only_primitive_operations := true );;
...
gap> AdditiveMonoidalCategoriesTest( rows, a, L : only_primitive_operations := true );;
...
gap> BraidedMonoidalCategoriesTest( rows, a, b : only_primitive_operations := true );;
...
gap> alpha := CategoryOfRowsMorphism( a, HomalgMatrix( [ 2 .. 7 ], RankOfObject( a ), RankOfObject( b ), Q ), b );;
gap> beta := CategoryOfRowsMorphism( c, HomalgMatrix( [ 8 .. 19 ], RankOfObject( c ), RankOfObject( d ), Q ), d );;
gap> gamma := CategoryOfRowsMorphism( a_tensor_b, HomalgMatrix( [ 2 .. 7 ], RankOfObject( a_tensor_b ), RankOfObject( u ), Q ), u );;
gap> delta := CategoryOfRowsMorphism( c_tensor_d, HomalgMatrix( [ 8 .. 19 ], RankOfObject( c_tensor_d ), RankOfObject( u ), Q ), u );;
gap> epsilon := CategoryOfRowsMorphism( u, HomalgMatrix( [ 2 .. 7], RankOfObject( u ), RankOfObject( hom_ab ), Q ), hom_ab );;
gap> zeta := CategoryOfRowsMorphism( u, HomalgMatrix( [ 8 .. 19 ], RankOfObject( u ), RankOfObject( hom_cd ), Q ), hom_cd );;

gap> ClosedMonoidalCategoriesTest( rows, a, b, c, d, alpha, beta, gamma, delta, epsilon, zeta : only_primitive_operations := true );;
...
gap> delta := CategoryOfRowsMorphism( u, HomalgMatrix( [ 8 .. 19 ], RankOfObject( u ), RankOfObject( c_tensor_d ), Q ), c_tensor_d );;
gap> epsilon := CategoryOfRowsMorphism( cohom_ab, HomalgMatrix( [ 2 .. 7 ], RankOfObject( cohom_ab ), RankOfObject( u ), Q ), u );;
gap> zeta := CategoryOfRowsMorphism( cohom_cd, HomalgMatrix( [ 8 .. 19 ], RankOfObject( cohom_cd ), RankOfObject( u ), Q ), u );;

gap> CoclosedMonoidalCategoriesTest( rows, a, b, c, d, alpha, beta, gamma, delta, epsilon, zeta : only_primitive_operations := true );;
...
gap> RigidSymmetricClosedMonoidalCategoriesTest( rows, a, b, c, d, alpha : only_primitive_operations := true );;
...
gap> RigidSymmetricCoclosedMonoidalCategoriesTest( rows, a, b, a, b, alpha : only_primitive_operations := true );;
