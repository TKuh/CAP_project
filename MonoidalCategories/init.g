...
ReadPackage( "MonoidalCategories", "gap/SymmetricMonoidalCategoriesDoc.gd" );

## Closed Monoidal
ReadPackage( "MonoidalCategories", "gap/ClosedMonoidalCategoriesDoc.gd" );
ReadPackage( "MonoidalCategories", "gap/ClosedMonoidalCategories.gd" );

ReadPackage( "MonoidalCategories", "gap/SymmetricClosedMonoidalCategoriesDoc.gd" );
