...
AddDerivationToCAP( BraidingInverseWithGivenTensorProducts,
                    "BraidingInverseWithGivenTensorProducts via BraidingWithGivenTensorProducts with reordered arguments",
...
AddDerivationToCAP( BraidingWithGivenTensorProducts,
                    "BraidingWithGivenTensorProducts via BraidingInverseWithGivenTensorProducts with reordered arguments",
  ...
  function( cat, object_1_tensored_object_2, object_1, object_2, object_2_tensored_object_1 )
    ...
    return BraidingInverseWithGivenTensorProducts( cat, object_1_tensored_object_2, object_2, object_1, object_2_tensored_object_1 );
