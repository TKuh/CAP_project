...
#! true
ReadPackage( "AdditiveClosuresForCAP",
    "gap/AdditiveClosureOfLinearClosureOfFiniteSkeletalDiscreteCategory_CompilerLogic.gi" );
#! true
...
precompile_AdditiveClosureOfObjectFiniteCategory := function( homalg_ring, name )
    ...
    CapJitPrecompileCategoryAndCompareResult(
        homalg_ring ->
            AdditiveClosureDisconnectedOfLinearClosureOfFiniteSkeletalDiscreteCategory(
        ...
        Concatenation(
            "AdditiveClosureOfObjectFiniteDisconnectedCategory_LinearClosure_over_",
            name,
